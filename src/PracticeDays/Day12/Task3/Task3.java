package PracticeDays.Day12.Task3;
...
public class Task3 {
    public static void main(String[] args) {
        ...
        MusicBand band4=new MusicBand("Skryptonit",2018);
        ...
        MusicBand band8=new MusicBand("Jimi",1966);
        MusicBand band9=new MusicBand("Kedr Livanskii",2008);
